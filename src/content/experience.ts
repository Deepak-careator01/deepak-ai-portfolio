...
export const experience: Experience[] = [
  {
    ...
    current: true,
    description:
      "Building an AI-native portfolio with a streaming copilot using Next.js, TypeScript, and the Vercel AI SDK — with a phased roadmap toward RAG and LangGraph agents.",
    responsibilities: [
      "Architect content-driven portfolios designed for future RAG ingestion and agent tooling",
      "Implement streaming AI chat with the Vercel AI SDK and Groq",
      "Design scalable Next.js folder structures for production applications",
      "Define TypeScript content models shared by UI and the AI context pipeline",
    ],
    technologies: [
      "Next.js",
      "TypeScript",
    ...
    achievements: [
      "Shipped streaming AI copilot UI with portfolio context injection",
      "Established a strict content-layer architecture reusable across UI and AI pipelines",
      "Designed phased roadmap from portfolio UI to agentic copilot with RAG, tools, and memory",
    ],
