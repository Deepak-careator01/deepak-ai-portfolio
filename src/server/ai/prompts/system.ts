 ...
 *
 * This prompt is combined with the portfolio context generated from the
 * content layer (`src/content` and MDX case studies). It defines:
 * - Scope: Deepak's portfolio only
 * - Tone: professional, friendly, technically accurate
 * - Behaviors: no fabrication, clear fallbacks, navigation suggestions
 */
